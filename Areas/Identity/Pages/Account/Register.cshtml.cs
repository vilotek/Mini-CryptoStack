...
public class RegisterModel : PageModel
{
    ...
    private ApplicationUser CreateUser()
    {
        ...
        catch
        {
            throw new InvalidOperationException(
                ...
                $"Upewnij się, że nie jest abstrakcyjna i ma bezparametrowy konstruktor.");
        }
    }
    ...
    private IUserEmailStore<ApplicationUser> GetEmailStore()
    {
        ...
        {
            throw new NotSupportedException("Domyślny UI wymaga magazynu użytkowników z obsługą email.");
        }
